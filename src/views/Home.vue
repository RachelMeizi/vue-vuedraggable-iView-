<template>
    <div>
        <PageHeader class="product_tabs" :title="$route.meta.title" hidden-breadcrumb>
            <div slot="title">
                页面设计
                <router-link :to="{path:'/'}"><Button icon="ios-arrow-back" size="small"  class="mr20">返回</Button></router-link>
    ...
    export default {
        ...
        methods: {
            ...
            log: function (evt) {
                ...
                console.log(this.rConfig,'log-this.rConfig')
            ...
            saveConfig () {
                ...
                console.log(this.pageName,this.pageType,val,"44444444")
                diySave(this.pageId, {
                    name: this.pageName,
                    type: this.pageType,
                    value: val
